...
public class HttpClientUtil {
    ...
    // GZIP请求设置超时时间30秒
    private final static int OUTTIME = 30000;
    ...
    // HttpClient设置为4s
    private final static int CONNECT_TIMING_OUT = 30000;
    private final static int RESPONSE_TIMING_OUT = 30000;
    /**
     * @param url    请求路径
     * @param params 请求参数
     * @return
     ...
     * @throws Exception
     */
    public static String post(String url, Map<String, String> headerParam, Map<Object, Object> bodyParam, String contentType, String charSet) throws Exception {
        ...
        try {
            response = createClient(url).execute(httpPost);
     ...
     * @throws Exception
     */
    public static byte[] postGzip(String sendurl, byte[] bytes, Map<String, String> headMap) throws Exception {
    ...
    private static CloseableHttpClient createHttpsClient() throws Exception {
        ...
        RequestConfig requestConfig = RequestConfig.custom()
                .setConnectTimeout(CONNECT_TIMING_OUT)
                .setConnectionRequestTimeout(CONNECT_TIMING_OUT)
                .setSocketTimeout(RESPONSE_TIMING_OUT).build();
    ...
    private static CloseableHttpClient createClient(String url) throws Exception {
